...
st.markdown(
    ...
    <style>
      ...
      div[role="tablist"]::before{
        content: "";
        position: fixed;
        top: 3.2rem;             /* starts right after the topbar mask */
        left: 0;
        right: 0;
        height: 3.1rem;          /* covers the whole tabs region */
        background: #0e1117;
        z-index: -1;
      }
...
with tab_scenario:
    ...
    st.plotly_chart(fig5, use_container_width=True, key="total_co2_vs_total_al")
    ...
    st.plotly_chart(fig6, use_container_width=True, key="intensity_vs_total_al")
